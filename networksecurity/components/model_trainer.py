...
## r2 is used as a regression model, not for classification, CHANGE
...
import mlflow
import dagshub
dagshub.init(repo_owner='sghoshcodes', repo_name='netwrksecurityPROJ', mlflow=True)
...
class ModelTrainer:
    ...
    def train_model(self, x_train, y_train, x_test, y_test):
        ...
        ## Track the experiments via mlflow
